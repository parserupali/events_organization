...
class EventOrganizersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create event_organizer' do
    assert_difference('EventOrganizer.count') do
      post event_organizers_url,
           params: { event_organizer: { company_name: @event_organizer.company_name, phone_number: @event_organizer.phone_number, user_id: @event_organizer.user_id } }, as: :json
    end
  ...
  test 'should update event_organizer' do
    patch event_organizer_url(@event_organizer),
          params: { event_organizer: { company_name: @event_organizer.company_name, phone_number: @event_organizer.phone_number, user_id: @event_organizer.user_id } }, as: :json
    assert_response :success
  end
